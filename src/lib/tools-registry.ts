...
export const tools: Tool[] = [
  ...
  {
    id: "ai-regex",
    name: "AI Regex Studio",
    description:
      "Generate Regular Expressions from natural language or break down complex patterns token by token.",
    href: "/tools/ai-regex",
    icon: Regex,
    category: "ai",
    status: "active",
  ...
  {
    id: "ai-schema",
    name: "AI Database Schema Mapper",
    description:
      "Convert SQL DDL queries and models to Prisma Schemas, Drizzle ORM, TypeORM, and Zod.",
  ...
  },
  {
    ...
    description:
      "Generate comprehensive unit test suites with mocks in Vitest, Jest, Pytest, or Go.",
    href: "/tools/ai-unit-tests",
    icon: FlaskConical,
    category: "ai",
    status: "active",
    keywords: [
  ...
  {
    id: "ai-refactor",
    name: "AI Code Refactor & Optimizer",
    description:
      "Modernize legacy code to React 19/ES2024, optimize Big-O algorithms, and convert JS to TypeScript.",
    href: "/tools/ai-refactor",
    icon: Wand2,
    category: "ai",
    status: "active",
    keywords: [
  ...
  {
    id: "ai-docs",
    name: "AI API Docs & OpenAPI Generator",
    description:
      "Generate Swagger / OpenAPI 3.0 specs (YAML/JSON), Markdown developer guides, and typed JSDoc comments.",
    href: "/tools/ai-docs",
    icon: BookOpen,
    category: "ai",
    status: "active",
