...
export default function CssUnitConverter() {
  ...
  const simulatedSizePx = useMemo(() => {
    ...
    return Number(
      (minFontSize + ratio * (maxFontSize - minFontSize)).toFixed(1),
    );
          ...
          <div className="space-y-4 flex flex-col">
              ...
              <CardContent className="p-5 space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-xs font-bold uppercase tracking-wider text-purple-300 flex items-center gap-2">
                    <Sliders className="size-3.5" /> Typography & Viewport
                    Boundaries
                  </h3>
                  <Badge
                    variant="outline"
                    className="text-[10px] border-purple-500/30 text-purple-300 font-mono"
                  >
            ...
            <Card className="border border-cyan-500/30 bg-[#0d1527] shadow-xl flex-1 flex flex-col">
              <CardContent className="p-5 space-y-4 flex-1 flex flex-col justify-between">
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <Label className="text-xs font-bold uppercase tracking-wider text-cyan-300 flex items-center gap-2">
                      <Maximize2 className="size-3.5" /> Interactive Viewport
                      Simulator
                    </Label>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setPreviewViewport(parseInt(e.target.value, 10))
                    }
                ...
                {/* Visual Preview Box */}
                <div className="p-6 rounded-2xl bg-black/40 border border-white/10 flex items-center justify-center min-h-35 text-center overflow-hidden">
                  <p
                    style={{
                      fontSize: `${simulatedSizePx}px`,
                      lineHeight: 1.15,
                    }}
                    className="font-extrabold text-transparent bg-clip-text bg-linear-to-r from-purple-300 via-white to-cyan-300 transition-all duration-75"
                  >
                    Fluid Heading Text
                  </p>
                </div>
              ...
              <div className="p-4 rounded-2xl border border-purple-500/30 bg-[#0d1527] shadow-xl space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    size="xs"
                    onClick={() =>
                      handleCopy(clampResult.clampCss, "CSS clamp()")
                    }
              ...
              <div className="p-4 rounded-2xl border border-cyan-500/30 bg-[#0d1527] shadow-xl space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    size="xs"
                    onClick={() =>
                      handleCopy(clampResult.tailwindClass, "Tailwind Class")
                    }
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-xs font-semibold text-slate-300">
                <span className="flex items-center gap-1.5">
                  <Code2 className="size-4 text-purple-400" /> Full CSS Rule
            ...
            <CardContent className="p-6 space-y-5">
              <div className="flex items-center justify-between">
                <h3 className="text-sm font-bold text-white flex items-center gap-2">
                  <Sliders className="size-4 text-purple-400" /> Unit Input
                  &amp; Root Configuration
                </h3>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    value={unitValue}
                    onChange={(e) =>
                      setUnitValue(parseFloat(e.target.value) || 0)
                    }
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    value={fromUnit}
                    onChange={(e) =>
                      setFromUnit(e.target.value as typeof fromUnit)
                    }
              ...
              <div className="space-y-1.5 pt-2 border-t border-white/5">
                ...
                <Input
                  ...
                  value={rootSize}
                  onChange={(e) =>
                    setRootSize(parseFloat(e.target.value) || 16)
                  }
